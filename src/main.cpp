// Program 'Esp32_RingDoorBell_Alexa_Sinric_FritzPhone'
// Copyright RoSchmi 2022, License Apache 2.0
// 
...
// When you start using the application set 'WORK_WITH_WATCHDOG' to 0.
// When everthing is working, set 'WORK_WITH_WATCHDOG' to 1.
...
{      
  ...
  int relayPIN;
  int flipSwitchPIN;
  bool hasPowerMeasure;   // Some switches like Fritz!Dect can measure power
  int index;
} deviceConfig_t;
...
// right now we have 2 devicesIds 
...
void setup() 
{
  ...
  // For debugging, some infos about the last boot reason
...
{ 
  ...
  // Test Fritzbox SID e.g. every minute to keep it valid
